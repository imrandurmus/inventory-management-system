...
} from "./chunk-RGNGTCU6.js";
import {
  require_jsx_runtime
} from "./chunk-MQZP6FJC.js";
import {
  require_react
...
// node_modules/motion/node_modules/motion-utils/dist/cjs/index.js
var require_cjs = __commonJS({
  "node_modules/motion/node_modules/motion-utils/dist/cjs/index.js"(exports) {
    "use strict";
...
// node_modules/motion/node_modules/motion-dom/dist/cjs/index.js
var require_cjs2 = __commonJS({
  "node_modules/motion/node_modules/motion-dom/dist/cjs/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/motion/node_modules/framer-motion/dist/cjs/index.js
var require_cjs3 = __commonJS({
  "node_modules/motion/node_modules/framer-motion/dist/cjs/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var easingDefinitionToFunction = (definition) => {
      if (motionDom.isBezierDefinition(definition)) {
        ...
        motionUtils.invariant(easingLookup[definition] !== void 0, `Invalid easing type '${definition}'`);
    ...
    function PopChild({ children, isPresent: isPresent2 }) {
      ...
      return jsxRuntime.jsx(PopChildMeasure, { isPresent: isPresent2, childRef: ref, sizeRef: size, children: React__namespace.cloneElement(children, { ref }) });
    }
    var PresenceChild = ({ children, initial, isPresent: isPresent2, onExitComplete, custom, presenceAffectsLayout, mode }) => {
      ...
      if (mode === "popLayout") {
        children = jsxRuntime.jsx(PopChild, { isPresent: isPresent2, children });
      }
    ...
    var AnimatePresence = ({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false }) => {
      ...
      return jsxRuntime.jsx(jsxRuntime.Fragment, { children: renderedChildren.map((child) => {
        ...
        return jsxRuntime.jsx(PresenceChild, { isPresent: isPresent2, initial: !isInitialRender.current || initial ? void 0 : false, custom: isPresent2 ? void 0 : custom, presenceAffectsLayout, mode, onExitComplete: isPresent2 ? void 0 : onExit, children: child }, key);
      }) });
    };
    ...
    function createScopedAnimate(scope) {
      function scopedAnimate(subjectOrSequence, optionsOrKeyframes, options) {
        ...
        const animation = new motionDom.GroupPlaybackControls(animations2);
        if (scope) {
    ...
    var NativeAnimation = class extends motionDom.NativeAnimationControls {
    ...
    function mixValues(target, follow, lead, progress, shouldCrossfadeOpacity, isOnlyMember) {
      if (shouldCrossfadeOpacity) {
        ...
        target.opacity = mixNumber$1(follow.opacity !== void 0 ? follow.opacity : 1, lead.opacity !== void 0 ? lead.opacity : 1, progress);
      }
    ...
    function MotionConfig({ children, isValidProp, ...config }) {
      ...
      return jsxRuntime.jsx(MotionConfigContext.Provider, { value: context, children });
    }
    ...
    function getVelocity(history, timeDelta) {
      ...
      const time2 = motionUtils.millisecondsToSeconds(lastPoint.timestamp - timestampedPoint.timestamp);
      if (time2 === 0) {
        return { x: 0, y: 0 };
      }
    ...
    function createRendererMotionComponent({ preloadedFeatures, createVisualElement, useRender, useVisualState: useVisualState2, Component }) {
      var _a, _b;
    ...
    function ReorderItemComponent({ children, style = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
      ...
      return jsxRuntime.jsx(Component, { drag: axis, ...props, dragSnapToOrigin: true, style: { ...style, x: point2.x, y: point2.y, zIndex }, layout: layout2, onDrag: (event, gesturePoint) => {
    ...
    var AnimateSharedLayout = ({ children }) => {
      ...
      return jsxRuntime.jsx(LayoutGroup, { id: useConstant(() => `asl-${id++}`), children });
    };
    var maxScale = 1e5;
...
var require_react2 = __commonJS({
  "node_modules/motion/dist/cjs/react.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var framerMotion = require_cjs3();
    Object.keys(framerMotion).forEach(function(k) {
      if (k !== "default" && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
        enumerable: true,
        get: function() {
          return framerMotion[k];
        }
      });
    });
  }
...
var require_dist = __commonJS({
  "node_modules/react-animated-numbers/dist/index.js"(exports) {
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports, "__esModule", { value: true });
    var react_1 = __importDefault(require_react());
    var react_2 = require_react2();
    var NUMBERS = [
      0,
      1,
      2,
    ...
    var AnimatedNumber = ({ className, animateToNumber, fontStyle, transitions, includeComma, locale }) => {
      const ref = react_1.default.useRef(null);
      const isInView = (0, react_2.useInView)(ref, { once: true });
      const controls = (0, react_2.useAnimation)();
      const animateTonumberString = includeComma ? Math.abs(animateToNumber).toLocaleString(locale || "en-US") : String(Math.abs(animateToNumber));
      ...
      return react_1.default.createElement(
        ...
        numberHeight !== 0 && react_1.default.createElement("div", { style: {
          ...
          flexDirection: "row",
          overflow: "hidden"
        }, className }, animateToNumbersArr.map((n, index) => {
          if (typeof n === "string") {
          ...
          return react_1.default.createElement(react_2.motion.div, { key: `${n}_${index}`, style: {
            ...
            hidden: { y: 0 },
            visible: {
              y: -1 * (numberHeight * (typeof animateToNumbersArr[index] === "number" ? animateToNumbersArr[index] : 0)) - numberHeight * 20
            }
          }, animate: controls, transition: transitions === null || transitions === void 0 ? void 0 : transitions(index) }, NUMBERS.map((number, index2) => react_1.default.createElement("div", { key: index2, style: Object.assign(Object.assign({}, fontStyle), { fontVariantNumeric: "tabular-nums" }) }, number)));
        })),
        react_1.default.createElement("div", { ref: numberDivRef, style: Object.assign({ position: "absolute", top: -9999 }, fontStyle) }, 0)
      );
    };
    var Enhanced = react_1.default.memo(AnimatedNumber, (prevProps, nextProps) => {
